CREATE DATABASE bank_system_new;
USE bank_system_new;
...
CREATE TABLE current_transaction(
    TransactionId INT(40) PRIMARY KEY AUTO_INCREMENT,
    EmployeeId VARCHAR(40) NOT NULL,
    AccountNumber VARCHAR(40) NOT NULL,
    TransactionDate DATE NOT NULL,
    Amount DECIMAL(10,2) NOT NULL,
...
CREATE TABLE loan_request(
    RequestId INT(40) PRIMARY KEY AUTO_INCREMENT,
    CustomerId VARCHAR(40) NOT NULL,
    BranchId VARCHAR(40) NOT NULL,
    Amount DECIMAL(8,2) NOT NULL,
...
CREATE TABLE org_loan_request (
   RequestId int(20) PRIMARY KEY AUTO_INCREMENT,
   CustomerId varchar(40) NOT NULL,
   BranchId varchar(40) NOT NULL,
   Amount decimal(8,2) NOT NULL,
   ApprovedStatus enum('APPROVED','PENDING','REJECTED') DEFAULT 'PENDING',
   EmployeeId varchar(40) NOT NULL,
   ProjectGrossValue decimal(8,2) NOT NULL,
   LoanId varchar(40) DEFAULT NULL,
   LoanReason enum('Construction','Asset_Purchase','Refinancing','Other_Reason') NOT NULL,
   OrganizationType enum('Individual','Joint','Pvt_Ltd_Co','Limited_Co','Trust','Other') NOT NULL,
   RequestDate date NOT NULL
   );
