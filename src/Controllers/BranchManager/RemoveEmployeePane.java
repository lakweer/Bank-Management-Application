...
public class RemoveEmployeePane {
    ...
    public   RemoveEmployeePane(BranchMangerHome parent){
        this.parent =parent;
    }
    public GridPane removeEmployeePane(BorderPane pane){
        ...
        //Title
        Label headerLabel = new Label("Remove Employee From Branch");
        ...
        submitButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                String result = "";
                result = parent.getModel().removeNormalEmployee(nicText.getText());
