...
public class OrganizationCustomerSearch {
    private EmployeeHome parent;

    protected OrganizationCustomerSearch(EmployeeHome parent){
        this.parent =parent;
    }

    protected GridPane OrganizationCustomerSearchUI(BorderPane pane){
        ...
        //Main Title
        Label mainTitle = new Label("Organization Customer Search");
